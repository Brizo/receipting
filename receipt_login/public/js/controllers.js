angular.module('receipt')
	.controller('manageUsers',['$q','$document','$scope','$http', '$compile', 'manageData','getParams','recSwitch',  function($q,$document,$scope, $http, $compile, manageData, getParams, recSwitch){
		...
		$scope.getLoggedInUser = function () {
			$http.post('/api/getLoggdUser').success(function (data) {
				$scope.loggedInU = data;
				console.log(data);
			});
		}
    	...
    	$scope.assignCashier = function (id) {
	        ...
	        console.log("The employee to be assigned : ");
	        console.log(id);

	        var updateCashier = {
	            assignStatus:"pending",
	            uname:$scope.usernmeU,
	            currStn:$scope.currentStnU,
	            station:$scope.transferStn, 
	            currentDate: new Date(),
	            startDate : $scope.transferStartDate, 
	            endDate: $scope.transferEndDate
	        };
